...
from utils.data_pred import predict_from_saved
...
class ModelWithTemperature(nn.Module):
    ...
    def set_temperature(self, tokenizer, val_set):
        """
        ...
        with torch.no_grad():
            labels = torch.tensor(val_set["labels"].to_numpy()).to(self.device)
