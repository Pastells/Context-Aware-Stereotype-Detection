...
def get_data(
    ...
    data: detests or stereohoax
    context:
        - Stereohoax: None, txt_father, txt_head or rh_text
        - DETESTS: None, previous_sentences, previous_comment, first_comment, news_title
    ...
    if data == "detests":
        ...
        if files is None:
            files = (
                ...
                f"test_with_disagreement_context{no_fill}_soft.csv",
            )
